...
const { MAX_QUESTION_LEN, MAX_ATTEMPT_LEN } = require('../lib/limits');
...
function isValidShape(obj) {
  return obj && MISTAKE_CATEGORIES.includes(obj.category) &&
    typeof obj.firstStep === 'string' && typeof obj.why === 'string' &&
    typeof obj.tiny === 'string' && typeof obj.practice === 'string';
}
...
async function handler(req, res) {
  ...
  const cacheKey = makeCacheKey('detect-mistake', { q: question.trim().toLowerCase(), a: attempt.trim().toLowerCase() });
